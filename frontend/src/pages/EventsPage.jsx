  ...
  return (
    <main className="dashboard-main student-page">
      ...
      <form className="filter-bar" onSubmit={submit} aria-label="Filter events">
        ...
        <label><span>Free only</span><select value={filters.free} onChange={(event) => setFilters({ ...filters, free: event.target.value })}><option value="">{'All'}</option><option value="true">Free only</option><option value="false">Paid only</option></select></label>
